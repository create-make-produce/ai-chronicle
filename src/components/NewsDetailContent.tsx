...
export default function NewsDetailContent({ news, relatedTool, relatedNews, locale }: NewsDetailContentProps) {
  ...
  return (
    <main className="flex-1">
      ...
      {/* ━━━ ヒーローヘッダー ━━━ */}
      <div style={{
        background: 'linear-gradient(135deg, #040912 0%, #0A1628 60%, #081428 100%)',
        ...
        <div style={{
          ...
          backgroundImage: 'radial-gradient(circle at 1px 1px, rgba(0,140,237,0.08) 1px, transparent 0)',
