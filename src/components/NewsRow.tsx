...
export default function NewsRow({ item, href, lang, isLast }: NewsRowProps) {
  ...
  return (
    ...
    >
      <span className="hidden sm:block" style={{ fontFamily: 'Fira Sans, monospace', fontSize: '0.78rem', color: '#4A5568', letterSpacing: '0.02em', flexShrink: 0, width: '90px' }}>
        {date}
      </span>
      <span style={{
      ...
      <span style={{ fontFamily: lang === 'en' ? 'Inter, sans-serif' : 'Noto Sans JP, sans-serif', fontSize: '0.88rem', color: '#B0BAC5', flex: 1, minWidth: 0, overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' as const }}>
        {title}
      </span>
