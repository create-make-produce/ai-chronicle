...
const SECTIONS = [
  ...
  {
    title: '3. 広告の配信について',
    body: '当サイトは、第三者配信の広告サービス「Google AdSense」を利用しています。広告配信事業者は、ユーザーの興味に応じた商品やサービスの広告を表示するため、当サイトや他サイトへのアクセスに関する情報（氏名、住所、メールアドレス、電話番号は含まれません）を使用することがあります。\n\nGoogleなどの第三者配信事業者は、Cookieを使用して、ユーザーが当サイトや他のウェブサイトに過去にアクセスした際の情報に基づいて広告を配信します。Googleのクッキーの使用については、Googleの広告に関するポリシー（https://policies.google.com/technologies/ads）をご確認ください。\n\nユーザーは、広告設定（https://www.google.com/settings/ads）でパーソナライズド広告を無効にすることができます。また、aboutads.info（https://www.aboutads.info/）にアクセスすれば、第三者配信事業者のCookie使用によるパーソナライズド広告配信を無効にできます。',
  },
  {
