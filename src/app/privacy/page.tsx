...
const SECTIONS = [
  ...
  {
    title: '3. 広告の配信について',
    body: '当サイトは、第三者配信の広告サービス「Google AdSense」を利用しています。広告配信事業者は、ユーザーの興味に応じた商品やサービスの広告を表示するため、当サイトや他サイトへのアクセスに関する情報（氏名、住所、メールアドレス、電話番号は含まれません）を使用することがあります。\n\nGoogle AdSenseでは、Cookieを使用することにより、ユーザーが当サイトや他のサイトにアクセスした際の情報に基づいて、Googleおよびそのパートナーがユーザーに適切な広告を表示できるようになります。Googleは広告配信にDARTクッキーを使用します。ユーザーは、Googleの広告およびコンテンツネットワークのプライバシーポリシー（https://policies.google.com/technologies/ads）にアクセスすることで、DARTクッキーの使用を無効にできます。\n\nユーザーは、広告設定（https://www.google.com/settings/ads）でパーソナライズド広告を無効にすることができます。また、www.aboutads.infoにアクセスすれば、第三者配信事業者のCookie使用によるパーソナライズド広告配信を無効にできます。',
  },
  {
