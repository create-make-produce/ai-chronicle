...
export const CONFIG = {
  ...
  // ----------------------------------------
  SCRAPE_NEW_TOOLS_INTERVAL_HOURS: 24,      // 新着ツール収集の間隔（時間）
  ...
  // ----------------------------------------
  MAX_NEW_TOOLS_PER_RUN: 20,                // 1回の実行で新規登録する最大ツール数
  ...
  PRODUCT_HUNT_POSTS_PER_REQUEST: 20,       // 1リクエストで取得する件数
  PRODUCT_HUNT_MIN_VOTES: 10,               // 登録対象の最小投票数フィルター
