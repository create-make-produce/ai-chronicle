...

{
  ...
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。難しい専門用語は使わず何が便利かが分かりやすい文章にする。何ができるツールか・特徴・想定ユーザーを含む。文字数：300〜1000文字。「。」は全体で4〜5個以内に抑える。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。本文中にURLを記載しないこと）",
...

{
  ...
  "title_en": "English title (under 60 characters)",
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。難しい専門用語は使わず何が便利かが分かりやすい文章にする。どんな機能か・誰に役立つか・使い方を含む。文字数：300〜1000文字。「。」は全体で4〜5個以内に抑える。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。本文中にURLを記載しないこと）",
...

{
  ...
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。難しい専門用語は使わず何が便利かが分かりやすい文章にする。何がいつから変わるか・影響するユーザーを含む。文字数：300〜1000文字。「。」は全体で4〜5個以内に抑える。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。本文中にURLを記載しないこと）",
  "body_en": "English body (10-15 lines)"
}`;
...

{
  "title_ja": "日本語タイトル（30文字以内・【重要】ツール名・製品名は絶対に含めない・何がどう変わったかを書く。例：「無料プランが廃止、全プラン有料化へ」「月額プランが値上げ、新料金は来月から適用」）",
  "title_en": "English title (under 60 characters)",
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。難しい専門用語は使わず何が便利かが分かりやすい文章にする。何がどう変わるか・影響するユーザーを含む。文字数：300〜1000文字。「。」は全体で4〜5個以内に抑える。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。本文中にURLを記載しないこと）",
  "body_en": "English body (10-15 lines)"
}`;
...

{
  ...
  "title_en": "English title (under 60 characters)",
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。難しい専門用語は使わず何が便利かが分かりやすい文章にする。何が発表されたか・背景・影響を含む。文字数：300〜1000文字。「。」は全体で4〜5個以内に抑える。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。本文中にURLを記載しないこと）",
  "body_en": "English body (10-15 lines)"
}`;
