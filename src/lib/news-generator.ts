...

{
  ...
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。AI初心者でも興味が引けるよう難しい専門用語は使わず何が便利かが直感的に伝わる文章にする。ただし幼稚な表現・過度な説明は避ける。何ができるツールか・特徴・想定ユーザーを含む。文字数：300〜1000文字。「。」は150〜200文字に1回を目安にする。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。情報量は削らない。本文中にURLを記載しないこと）",
...

{
  ...
  "title_en": "English title (under 60 characters)",
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。AI初心者でも興味が引けるよう難しい専門用語は使わず何が便利かが直感的に伝わる文章にする。ただし幼稚な表現・過度な説明は避ける。どんな機能か・誰に役立つか・使い方を含む。文字数：300〜1000文字。「。」は150〜200文字に1回を目安にする。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。情報量は削らない。本文中にURLを記載しないこと）",
...

{
  ...
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。AI初心者でも興味が引けるよう難しい専門用語は使わず何が便利かが直感的に伝わる文章にする。ただし幼稚な表現・過度な説明は避ける。何がいつから変わるか・影響するユーザーを含む。文字数：300〜1000文字。「。」は150〜200文字に1回を目安にする。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。情報量は削らない。本文中にURLを記載しないこと）",
  "body_en": "English body (10-15 lines)"
}`;
...
{
  "title_ja": "日本語タイトル（30文字以内・例：「${tool.name_ja}が料金プランを改定」）",
  "title_en": "English title (under 60 characters)",
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。AI初心者でも興味が引けるよう難しい専門用語は使わず何が便利かが直感的に伝わる文章にする。ただし幼稚な表現・過度な説明は避ける。何がどう変わるか・影響するユーザーを含む。文字数：300〜1000文字。「。」は150〜200文字に1回を目安にする。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。情報量は削らない。本文中にURLを記載しないこと）",
  "body_en": "English body (10-15 lines)"
}`;
...

{
  ...
  "title_en": "English title (under 60 characters)",
  "body_ja": "日本語本文（日本のニュース記事のような文体で書く。AI初心者でも興味が引けるよう難しい専門用語は使わず何が便利かが直感的に伝わる文章にする。ただし幼稚な表現・過度な説明は避ける。何が発表されたか・背景・影響を含む。文字数：300〜1000文字。「。」は150〜200文字に1回を目安にする。「。」の後は必ず改行を入れる。複数の内容は「。」で区切らず「、」でつないで1文にまとめる。情報量は削らない。本文中にURLを記載しないこと）",
  "body_en": "English body (10-15 lines)"
}`;
